...
export default class RegisterPage extends Component {
	...
	register() {
		...
		if (data.password != data.password1) {
			...
			return;
		} else if (data.name == '' || data.userId == '' || data.password == '') {
	...
	render() {
		return (
			<div className='loginSectionCon'>
				<a href='#'>
					<img src='images/logo.png' alt='BanBeis' className='loginLogo' />
				</a>
				<h2>নিবন্ধন করুন</h2>
				<div className='logFieldContainer'>
					...
					<input
						...
						className='loginField'
						ref='userId'
						placeholder='ইউজার আইডি অথবা ইমেইল লিখুন'
					/>
					<p>অ্যাকটিভেশন কোড</p>
					<input
						type='text'
						className='loginField'
						ref='code'
						placeholder='অ্যাকটিভেশন কোড লিখুন'
					/>
					<p>পাসওয়ার্ড</p>
					<input
						type='password'
